...
class AboutDialog(gtk.AboutDialog):
    ...
    def __new__(cls):
        ...
        """
        builder = get_builder('AboutLabalyzerDialog')
        new_object = builder.get_object("about_labalyzer_dialog")
    ...
    def finish_initializing(self, builder):
        ...
        to finish initializing the start of the new AboutLabalyzerDialog
        instance.
