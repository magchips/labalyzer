...
class PreferencesDialog(gtk.Dialog):
    ...
    def __new__(cls):
        ...
        """
        builder = get_builder('PreferencesLabalyzerDialog')
        new_object = builder.get_object("preferences_labalyzer_dialog")
    ...
    def finish_initializing(self, builder):
        ...
        finish initializing the start of the new PerferencesLabalyzerDialog
        instance.
