...
import gtk
import logging
logger = logging.getLogger('labalyzer_lib')

from . helpers import get_builder, show_uri, get_help_uri

# This class is meant to be subclassed by LabalyzerWindow.  It provides
...
class Window(gtk.Window):
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated BaseLabalyzerWindow object.
        """
        builder = get_builder('LabalyzerWindow')
        new_object = builder.get_object("labalyzer_window")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a LabalyzerWindow object with it in order to finish
        initializing the start of the new LabalyzerWindow instance.
        """
        ...
        # preferences.connect('changed', self.on_preferences_changed) #EDIT_WINDOWS
        ...
        try:
            ...
            LaunchpadIntegration.set_sourcepackagename('labalyzer')
        except ImportError:
            pass
        ...
        try:
            from labalyzer import indicator
    ...
    def on_mnu_about_activate(self, widget, data=None):
        """Display the about box for labalyzer."""
    ...
    def on_mnu_preferences_activate(self, widget, data=None):
        """Display the preferences window for labalyzer."""
